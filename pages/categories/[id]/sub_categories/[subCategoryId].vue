...
const { categoriesStore: { categories } } = useCategoriesStore()
...
const subCategory = computed(() => category.subCategories?.find((subCategory: SubCategoryType) => subCategory.id == id) || initSubCategory)
</script>
