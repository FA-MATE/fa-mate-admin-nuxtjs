  ...
  <nav class="bg-gray-800">
      ...
      <div class="relative flex h-16 items-center justify-between">
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex flex-shrink-0 items-center">
            <NuxtLink to="/"><div class="text-white rounded-md px-3 py-2 text-lg font-medium">FA-MATE Admin</div></NuxtLink>
          </div>
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <NuxtLink to="/condition_groups" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-4 text-xs font-medium">お譲り条件管理</NuxtLink>
    ...
    <div class="sm:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-8">
        ...
        <NuxtLink to="/condition_groups" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-4 text-sm font-medium">お譲り条件管理</NuxtLink>
